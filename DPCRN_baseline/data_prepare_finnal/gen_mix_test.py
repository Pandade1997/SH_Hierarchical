    ...
    for snr in snr_list:
        for rir in rir_list:
            ...
            parser.add_argument(
                '--clean_wav_list',
                type=str,
                default='/ddnstor/imu_panjiahui/dataset/SHdomainNew/loader_txt/test_clean_snr' + str(snr) + '_list.txt',
            ...
            parser.add_argument(
                '--noise_wav_list',
                type=str,
                default='/ddnstor/imu_panjiahui/dataset/SHdomainNew/loader_txt/test_noise_list.txt',
            ...
            parser.add_argument(
                '--rir_wav_list',
                type=str,
                default='/ddnstor/imu_panjiahui/dataset/SHdomainNew/loader_txt/rir_test_' + str(rir) + '.txt',
            ...
            parser.add_argument(
                '--mix_config_path',
                type=str,
                default='/ddnstor/imu_panjiahui/dataset/SHdomainNew/TIMIT/generated_data_cir_uniform_16/test/mix_test_' + str(
            ...
            parser.add_argument(
                '--save_dir',
                type=str,
                default='/ddnstor/imu_panjiahui/dataset/SHdomainNew/TIMIT/generated_data_cir_uniform_16/test/test_' + str(
                    rir) + '_snr' + str(snr),
            ...
            txt_path = os.path.join(
                '/ddnstor/imu_panjiahui/dataset/SHdomainNew/loader_txt/wav_scp_test_' + str(
