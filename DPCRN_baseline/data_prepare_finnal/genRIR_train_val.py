...
if __name__ == '__main__':
    # 定义目录名
    out_path = '/ddnstor/imu_panjiahui/dataset/SHdomainNew/RIR/cir_uniform_16/train_val_rir/'
    txt_path = '/ddnstor/imu_panjiahui/dataset/SHdomainNew/loader_txt'
    ...
    # ls -R /ddnstor/imu_panjiahui/dataset/SHdomainNew/TIMIT/Data/train_clean/*.WAV > /ddnstor/imu_panjiahui/dataset/SHdomainNew/loader_txt/train_clean_list.txt
    # ls -R /ddnstor/imu_panjiahui/dataset/SHdomainNew/TIMIT/Data/val_clean/*.WAV > /ddnstor/imu_panjiahui/dataset/SHdomainNew/loader_txt/val_clean_list.txt
    # ls -R /ddnstor/imu_panjiahui/dataset/SHdomainNew/TIMIT/Data/test_clean/*.WAV > /ddnstor/imu_panjiahui/dataset/SHdomainNew/loader_txt/test_clean_list.txt

    #find /ddnstor/imu_panjiahui/dataset/dns-challenge-2/datasets/noise/ -name "*.wav" | xargs -i ls -R {} > /ddnstor/imu_panjiahui/dataset/SHdomainNew/loader_txt/noise_list.txt
    # ls -R /ddnstor/imu_panjiahui/dataset/DIVERSE_multi_dataset/NOISE92X_CHIME3/*.wav > /ddnstor/imu_panjiahui/dataset/SHdomainNew/loader_txt/test_noise_list.txt

    # 带噪语音，训练集在dns noise 随机选2万句， 验证选2000句
