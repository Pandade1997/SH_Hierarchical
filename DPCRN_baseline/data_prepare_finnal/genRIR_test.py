...
if __name__ == '__main__':
    ...
    # 定义目录名
    out_path = '/ddnstor/imu_panjiahui/dataset/SHdomainNew/RIR/cir_uniform_16/test_rir/'
    ...
    for rt in t60:
        ...
        # 将文件路径写入txt文件
        RIR_txt_path = os.path.join(txt_path, "rir_test_" + str(rt) + ".txt")
        with open(RIR_txt_path, "w") as f:
            for file_path in RIR_file_paths:
                f.write(file_path + "\n")

        MIC_txt_path = os.path.join(txt_path, "mic_test_" + str(rt) + ".txt")
